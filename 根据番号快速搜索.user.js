...
(function() {
    ...
    findAndReplaceDOMText(allHTML, {
        ...
        replace: function(portion) {
            ...
            var oExclude = oOnlyText.search(/^(cpu|dos|win|os|osx|ipad|lumia|miui|flyme|emui|note|snh|bej|gnz|ckg|akb|gp|gt|gts|gtx|covid|aptx|rx|mh|bmw|sn|au|cc|cctv|shp|hao|top|scp|iso|it|ilc|ax|gbx|ds|error|df|qbz|qsz|ak)$/i)  
            //  和番号重名的没有排除: 
